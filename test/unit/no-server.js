...
describe("No Server side definition", function () {
    ...
    describe('No REST URL defined', function() {
        ...
        it('The template should load trough the REST URL', function() {
    ...
    describe('With REST URL defined', function() {
        ...
        it('$http should query the REST URL instead of domain.com', function(done) {
